...
import glob
txt_folder = "/media/hkuit164/WD20EJRX/0411_lb_txt/test/labels"
output_folder = "/media/hkuit164/WD20EJRX/0411_lb_txt/test/labels_test"
os.makedirs(output_folder, exist_ok=True)
txt_files = glob.glob(os.path.join(txt_folder, '*.txt'))

# def txt_content_dict(file_path):
#     content_dict = {}
#     with open(file_path, 'r', encoding='utf-8') as file:
#         for line_number, line_content in enumerate(file, start=0):
#             content_dict[line_number] = line_content.strip()
#     return content_dict
...
for filename in os.listdir(storage):
    ...
    # output_folder = "/media/hkuit164/WD20EJRX/tennis_multipose/tennis_player_pose/lb_json"
