...
def txtLabel_to_xmlLabel(classes_file,source_txt_path,source_img_path,save_xml_path):
    ...
    for file in os.listdir(source_txt_path):
        ...
        print(txt_file)
        xml_file = open(os.path.join(save_xml_path,file.replace('.txt','.jpg.xml')), 'w')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--classes_file', type=str, default="rgb.names")
    parser.add_argument('--source_txt_path', type=str, default="txt")
    parser.add_argument('--source_img_path', type=str, default="JPEGImages")
    parser.add_argument('--save_xml_path', type=str, default="Annotations")
